...
export const CTX_RUNTIME_CONTRACT = {
    ...
    ensureBotBackfill: ai('server_sim', 'implemented', {
        callbacks: ['onAction', 'onTick', 'onPhaseChange'],
        message: 'ctx.ensureBotBackfill(...) is the restart-safe platform bot lifecycle primitive. Call it every active tick/start with a deterministic blackboard so missing AI participants are rehydrated instead of relying on one-shot state flags.',
    }),
